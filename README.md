...
| `test_friday_full.py` | full behavioural/anti-leakage suite (**~158 checks**, Parts A–K, beyond minimum) |
...
```bash
python3 -m pytest test_friday_sample.py test_friday_full.py -q   # full gate: 158 checks
```
